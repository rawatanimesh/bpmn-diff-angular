 (function() {
  ...
  loadDiagram('left', { url: '/assets/bpmn-resources/sample-workflow/pizza-collaboration/old.bpmn' });
  loadDiagram('right', { url: '/assets/bpmn-resources/sample-workflow/pizza-collaboration/new.bpmn' });
